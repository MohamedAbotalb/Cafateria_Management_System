  ...
  <!-- Table -->
     ...
     <div class="container mt-5 text-center">
      <div class="row text-white" style="background-color: #362517; ">
        <div class="col-3 border border-2 text-center py-2"><h4>Order Date</h4></div>
        <div class="col-3 border border-2 text-center py-2"><h4>Status</h4></div>
        <div class="col-3 border border-2 text-center py-2"><h4>Amount</h4></div>
        <div class="col-3 border border-2 text-center py-2"><h4>Action</h4></div>
      </div>
      ...
      <div id="accordionExample">
        <div class="accordion-item border-0 p-0 m-0">
          ...
          <div
            id="collapseOne"
            class="accordion-collapse collapse row border border-2"
